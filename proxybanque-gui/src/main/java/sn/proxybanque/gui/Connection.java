...
public class Connection extends JFrame {
	...
	public Connection() {
		...
		panel_1.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Connection",
		...
		lblNewLabel.setIcon(
				new ImageIcon("C:\\developpement\\outil\\workpace\\proxibank\\proxybanque-gui\\image\\user.png"));
		...
		lblNewLabel_1.setIcon(
				new ImageIcon("C:\\developpement\\outil\\workpace\\proxibank\\proxybanque-gui\\image\\images.png"));
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (loginSaisie.length() == 0 || passWordSaisie.length() == 0) {
					...
					if (employerConnecter != null) {
						...
						dispose();
						if (type.equals("gerant") || type.equals("Gerant") || type.equals("gérant")
								|| type.equals("Gérant")) {
						...
						JOptionPane.showMessageDialog(null, "login ou mots de passe incorrect");
					}
				}
		...
		btnValider.setIcon(
				new ImageIcon("C:\\developpement\\outil\\workpace\\proxibank\\proxybanque-gui\\image\\check.png"));
		...
		btnAnnuler.setIcon(new ImageIcon(
				"C:\\developpement\\outil\\workpace\\proxibank\\proxybanque-gui\\image\\81927424-annuler-isolé-sur-orange-vitreux-rond-illustration-abstraite-de-bouton.jpg"));
		...
		btnNewButton.setIcon(
				new ImageIcon("C:\\developpement\\outil\\workpace\\proxibank\\proxybanque-gui\\image\\logout.png"));
